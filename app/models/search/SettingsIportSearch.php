...
/**
 * SettingsIportSearch represents the model behind the search form of `app\models\SettingsIport`.
 */
class SettingsIportSearch extends SettingsIport
{
    /**
     * {@inheritdoc}
     */
