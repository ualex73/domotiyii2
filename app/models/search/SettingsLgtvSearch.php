...
/**
 * SettingsLgtvSearch represents the model behind the search form of `app\models\SettingsLgtv`.
 */
class SettingsLgtvSearch extends SettingsLgtv
{
    /**
     * {@inheritdoc}
     */
