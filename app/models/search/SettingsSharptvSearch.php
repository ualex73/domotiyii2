...
/**
 * SettingsSharptvSearch represents the model behind the search form of `app\models\SettingsSharptv`.
 */
class SettingsSharptvSearch extends SettingsSharptv
{
    /**
     * {@inheritdoc}
     */
