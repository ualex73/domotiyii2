...
/**
 * SettingsRfxcomtrxSearch represents the model behind the search form of `app\models\SettingsRfxcomtrx`.
 */
class SettingsRfxcomtrxSearch extends SettingsRfxcomtrx
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'enabled', 'tcpport', 'debug', 'relayenabled', 'relayport', 'globalx10', 'oldaddrfmt'], 'integer'],
