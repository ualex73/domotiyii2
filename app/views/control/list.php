...
$this->title = Yii::t('app', 'Control List');
...
echo \yii\bootstrap\Nav::widget([
    ...
    'items' => [
        ['label' => Yii::t('app', 'Type') . ' : ' . Yii::t('app', $type), 'visible' => !Yii::$app->user->isGuest, 'url' => '#',
            'items' => [
                ['label' => 'Dashboard', 'url' => ['list?type=Dashboard&location=' . $location]],
                ['label' => 'All', 'url' => ['list?type=All&location=' . $location]],
                ['label' => 'Control', 'url' => ['list?type=Control&location=' . $location]],
                ['label' => 'Sensors', 'url' => ['list?type=Sensors&location=' . $location]],
            ],
        ],
...
<div class="row-fluid">
    <?php foreach ($data as $dev):?>
        ...
        <div class="device text-left" id="<?php echo $dev['id']; ?>">
            ...
            <div class="title">
                <img src="<?php echo Yii::$app->request->baseUrl?>/icons/<?= $dev['icon']?>"><span class="deviceName label label-info"><?php echo $dev['name']; ?></span>
                <i class="showValues fa fa-angle-down"></i>
