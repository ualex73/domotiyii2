...
<div class="cdr-index">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="active"><a class="condition-button" href="outgoing">Outgoing</a></li>
		<li><a class="action-button" href="no-answer">No Answer</a></li>
	</ul>
    <?= GridView::widget([
        'dataProvider' => $searchModel->search('outgoing'),
