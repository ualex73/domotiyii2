...
<div class="settings-rfxcomtx-form col-md-offset-1 col-md-4">
    ...
    <?= $form->field($model, 'disablex10')->checkbox() ?>

    <?= $form->field($model, 'enablearc')->checkbox() ?>

    <?= $form->field($model, 'handshake')->checkbox() ?>

    <?= $form->field($model, 'enableharrison')->checkbox() ?>

    <?= $form->field($model, 'enablekoppla')->checkbox() ?>

    <?= $form->field($model, 'rfxmitter')->checkbox() ?>
