...
/**
 * This is the model class for table "settings_rfxcomrx".
 *
 * @property integer $id
 ...
 */
class SettingsRfxcomrx extends \app\components\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['enabled', 'debug', 'relayenabled', 'globalx10'], 'boolean'],
