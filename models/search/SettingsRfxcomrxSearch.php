...
/**
 * SettingsRfxcomrxSearch represents the model behind the search form of `app\models\SettingsRfxcomrx`.
 */
class SettingsRfxcomrxSearch extends SettingsRfxcomrx
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'enabled', 'tcpport', 'debug', 'relayenabled', 'relayport', 'globalx10'], 'integer'],
