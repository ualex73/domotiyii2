...
/**
 * SettingsDenonSearch represents the model behind the search form of `app\models\SettingsDenon`.
 */
class SettingsDenonSearch extends SettingsDenon
{
    /**
     * {@inheritdoc}
     */
