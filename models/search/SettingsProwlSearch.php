...
/**
 * SettingsProwlSearch represents the model behind the search form of `app\models\SettingsProwl`.
 */
class SettingsProwlSearch extends SettingsProwl
{
    /**
     * {@inheritdoc}
     */
