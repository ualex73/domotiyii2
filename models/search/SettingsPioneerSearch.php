...
/**
 * SettingsPioneerSearch represents the model behind the search form of `app\models\SettingsPioneer`.
 */
class SettingsPioneerSearch extends SettingsPioneer
{
    /**
     * {@inheritdoc}
     */
