...
/**
 * SettingsOnkyoSearch represents the model behind the search form of `app\models\SettingsOnkyo`.
 */
class SettingsOnkyoSearch extends SettingsOnkyo
{
    /**
     * {@inheritdoc}
     */
